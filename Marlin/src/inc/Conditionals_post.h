...
#define HAS_ROTATIONAL_AXIS4 ((LINEAR_AXES >= 4) && (AXIS4_NAME == 'A' || 'B' || 'C'))
#define HAS_ROTATIONAL_AXIS5 ((LINEAR_AXES >= 5) && (AXIS5_NAME == 'B' || 'C'))
#define HAS_ROTATIONAL_AXIS6 ((LINEAR_AXES >= 6) && (AXIS6_NAME == 'C'))
#define HAS_ROTATIONAL_AXES (HAS_ROTATIONAL_AXIS4 || HAS_ROTATIONAL_AXIS5 || HAS_ROTATIONAL_AXIS6)
