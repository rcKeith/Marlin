...
#if STATUS_LOGO_WIDTH && ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && NONE(LCD_SHOW_SECONDARY_AXES, LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_LOGO 1
#endif
#if HOTENDS > 0 && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE) && !HAS_K_AXIS
  #define DO_DRAW_HOTENDS 1
#endif
#if HAS_HEATED_BED && HOTENDS <= 4 && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_BED 1
#endif
#if HAS_CUTTER && !DO_DRAW_BED && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_CUTTER 1
#endif
#if HAS_COOLER && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_COOLER 1
#endif
#if ENABLED(LASER_COOLANT_FLOW_METER) && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_FLOWMETER 1
#endif
#if ENABLED(I2C_AMMETER) && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_AMMETER 1
#endif

#if HAS_TEMP_CHAMBER && STATUS_CHAMBER_WIDTH && HOTENDS <= 4 && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define DO_DRAW_CHAMBER 1
#endif
#if HAS_FAN0 && STATUS_FAN_WIDTH && HOTENDS <= 4 && defined(STATUS_FAN_FRAMES) && NONE(LCD_SHOW_SECONDARY_AXES, LCD_SHOW_SECONDARY_AXES_LINE)
