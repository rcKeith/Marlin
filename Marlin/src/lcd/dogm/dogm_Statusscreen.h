...
#if STATUS_LOGO_WIDTH && ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && NEITHER(LCD_SHOW_SECONDARY_AXES, LCD_SHOW_SECONDARY_AXES_LINE)
  #define DO_DRAW_LOGO 1
#endif
#if HOTENDS > 0 && DISABLED(LCD_SHOW_SECONDARY_AXES_LINE)
...
#endif
#if HAS_FAN0 && STATUS_FAN_WIDTH && HOTENDS <= 4 && defined(STATUS_FAN_FRAMES) && NEITHER(LCD_SHOW_SECONDARY_AXES, LCD_SHOW_SECONDARY_AXES_LINE)
